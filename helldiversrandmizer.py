...
def generate_random_loadout():
  gun = [
    "AR-23 Liberator", "AR-23P Liberator Penetrator", "AR-23C Liberator Concussive", "R-63 Diligence", "R-63CS Diligence Counter Sniper", "SMG-37 Defender", "SG-8 Punisher", "SG-8S Slugger", "SG-225 Breaker", "SG-225SP Breaker Spray&Pray", "SG-225IE Breaker Incendiary", "LAS-5 Scythe", "LAS-16 Sickle", "PLAS-1 Scorcher"]
  gun2 = [
